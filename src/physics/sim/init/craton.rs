...
use crate::math::point_distribution::voronoi::VoronoiBuilder;
...
pub fn init_craton_voronoi_metaball(
    ...
    let voronoi =
        VoronoiBuilder::new(VoronoiConfig::new()).expect("Failed to create VoronoiBuilder");
    let relaxed_bevy_points = voronoi
        .generate_polygons(&mut seed_resource)
        .expect("Failed to generate polygons");
